...
- [x] **TASK-302**: Global Price Page
  - [x] List all products with price ranges
  - [x] Display: Product name, min price, max price, best shop
  - [x] Product images
  - [x] Category filter
...
- [x] **TASK-304**: Product Browse & Search
...
- [x] **TASK-503**: Navigation Components
...
- [x] **TASK-605**: Price Update Service
  - [x] Create price update
  - [x] Get price updates by shop
  - [x] Get current prices for shop
  - [x] Get price history
